...
class AddingArticle {
    ...
    private function addArticle(): bool {
        try {
...
END;
    ...
    public static function renderForm(string $destination = "processor.php"){
        ...
        <div><label><span>Zdjęcie</span><i class="fas fa-upload photoUploaderIcon"></i><input id="photoUploaderInput" type="file" name="photo"
         class="addingInput"></label></div>
