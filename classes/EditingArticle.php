...
END;
        ...
        echo<<<END
                <div><label><span>Data publikacji</span><input type="text" value="{$this->loadedArticle->publicationDate}"
                name="publicationDate" class="articleEditorInput" required></label></div>
