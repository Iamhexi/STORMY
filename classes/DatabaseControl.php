...
protected function reportException(Exception $e): void{
    if ($this->exceptionReporting === true)
        ...
        echo '<div class="prompt fail">Unfortunately, an error has occured!
        The administrator of the website has been already informed about this case.
         We would be thankful for your patience.</div>';
