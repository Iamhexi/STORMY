...
class SubpageEditor implements SubpageManagement{
    ...
    private const NEW_PAGE_CONTENT = '<h1>Nowa podstrona</h1>
                <p>Właśnie utworzyłeś nową podstronę.
                Teraz możesz edytować ją z poziomu panelu administratora.
                Dodaj tutaj, co tylko chcesz. Nie zapomnij tylko podpiąć tej podstrony do menu.
                Miłego tworzenia!</p>';
